...
class DashboardPrivate extends Component {
            ...
            if (respUsers != undefined && respUsers != null) {
                ...
                for (let i = 0; i < sorted_respUsers.length; i++) {
                    ...
                    [
                        ...
                        <Typography noWrap className={classes.typographyContent}>{score}</Typography>
                    ]
                    ];
                }
...
export default withStyles(styles)(withSnackbar(DashboardPrivate));